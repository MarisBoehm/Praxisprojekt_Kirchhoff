...
#setzt aktuellen schaltkreis in dem man sich befindet
def set_current_circuit(circuit_number):
    global current_circuit
    current_circuit = circuit_number

#Auswahl welceh berechnung ausgeführt wird abhängig davon welche schaltung angezeigt wird
def berechnen():
    global current_circuit
...
# Funktionen zur Berechnung der Systemmatrix Knotenspannungen
def display_matrix_schaltung1():
    try:
        ...
        matrix_str = (
            ...
            f"K1=0{'':<8}V    {'':16.2} IR1={IR1:<8.3f} A\n"
            f"K2={V1:<8.3f} V     {'':<16.2}IR2={IR2:<8.3f} A\n"
            f"K3={V1 - (R3 * x[1]):<8.3f} V     {'':<16.2}IR3={IR3:<8.3f} A\n"
            f"K4={V1:<8.3f} V\n"
            f"K5={V1:<8.3f} V\n"
            f"K6={V1:<8.3f} V\n"
        )
...
def display_matrix_schaltung2():
    try:
        ...
        matrix_str = (
            ...
            f"Knotenpotenziale:{'':<16.2} Ströme durch die Widerstände:\n"
            f"K1=0{'':<8}V    {'':16.2} IR1={IR1:<8.3f} A\n"
            f"K2=0{'':<8}V    {'':16.2} IR2={IR2:<8.3f} A\n"
            f"K3={VR1:<8.3f} V    {'':16.2} IR3={IR3:<8.3f} A\n"
            f"K4={(x[2] * R2):<8.3f} V    {'':16.2} IR4={IR4:<8.3f} A\n"
            f"K5={V1:<8.3f} V    {'':16.2} IR5={IR5:<8.3f} A\n"
            f"K6={V1:<8.3f} V\n"
...
def display_matrix_schaltung3():
    try:
        ...
        matrix_str = (
            ...
            f"K1=0{'':<8}V    {'':16.2} IR1={IR1:<8.3f} A\n"
            f"K2={V1:<8.3f} V    {'':16.2} IR2={IR2:<8.3f} A\n"
            f"K3={V1:<8.3f} V    {'':16.2} IR3={IR3:<8.3f} A\n"
            f"K4={(x[0] * R1):<8.3f} V    {'':16.2} IR4={IR4:<8.3f} A\n"
            f"K5={V1 - VR2:<8.3f} V    {'':16.2} IR5={IR5:<8.3f} A\n"
            f"K6={K69:<8.3f} V    {'':16.2} IR6={IR6:<8.3f} A\n"
            f"K7={V1 :<8.3f} V\n"
            f"K8={K69 - (x[2] * R6):<8.3f} V\n"
            f"K9={K69:<8.3f} V\n"
        )
...
def display_matrix_schaltung4():
    try:
        ...
        matrix_str = (
            ...
            f"Knotenpotenziale:{'':<16.2} Ströme durch die Widerstände:\n"
            f"K1=0{'':<8}V    {'':16.2} IR1={IR1:<8.3f} A\n"
            f"K1={VR3:<8.3f} V    {'':16.2} IR2={IR2:<8.3f} A\n"
            f"K2={VR3:<8.3f} V    {'':16.2} IR3={IR3:<8.3f} A\n"
            f"K3=0{'':<8}V\n"
            f"K4={V1 + VR3:<8.3f} V\n"
            f"K5={V2:<8.3f} V\n"
            f"K6={V2:<8.3f} V\n"
...
def draw_circuit_schaltung2(canvas):
    ...
    rect_3_4 = draw_rotated_rectangle(canvas, 280 + shift_x, 350 + shift_y, 280 + shift_x, 150 + shift_y, 60,
                                      20)  # Knoten 3 und 4
    rect_2_3 = draw_rotated_rectangle(canvas, 150 + shift_x, 250 + shift_y, 275 + shift_x, 350 + shift_y, 60,
                                      20)  # Knoten 2 und 3
    rect_2_4 = draw_rotated_rectangle(canvas, 150 + shift_x, 250 + shift_y, 275 + shift_x, 150 + shift_y, 60,
                                      20)  # Knoten 2 und 4
    rect_4_5 = draw_rotated_rectangle(canvas, 275 + shift_x, 150 + shift_y, 400 + shift_x, 250 + shift_y, 60,
                                      20)  # Knoten 4 und 5
    rect_3_5 = draw_rotated_rectangle(canvas, 285 + shift_x, 354 + shift_y, 410 + shift_x, 253 + shift_y, 60,
                                      20)  # Knoten 5 und 3

    # linien zeichnen
    canvas.create_line(280 + shift_x, 159 + shift_y, 280 + shift_x, 222 + shift_y, fill="blue", width=3)
    canvas.create_line(280 + shift_x, 280 + shift_y, 280 + shift_x, 350 + shift_y, fill="blue",
                       width=3)  # knoten 4 zu 3
    ...
    canvas.create_line(155 + shift_x, 260 + shift_y, 155 + shift_x, 400 + shift_y, fill="blue",
                       width=3)  # knoten 1 zu 2

    canvas.create_line(405 + shift_x, 400 + shift_y, 405 + shift_x, 260 + shift_y, fill="blue",
                       width=3)  # knoten 6 zu 5
...
def draw_circuit_schaltung3(canvas):
    ...
    canvas.create_line(210 + shift_x, 405 + shift_y, 400 + shift_x, 405 + shift_y, fill="blue",
                       width=3)  # Knoten 2 und 3
    canvas.create_line(405 + shift_x, 400 + shift_y, 405 + shift_x, 310 + shift_y, fill="blue",
                       width=3)  # Knoten 3 und 7
    ...
    canvas.create_line(305 + shift_x, 300 + shift_y, 305 + shift_x, 210 + shift_y, fill="blue",
                       width=3)  # Knoten 6 zu 9
    ...
    canvas.create_line(105 + shift_x, 210 + shift_y, 105 + shift_x, 300 + shift_y, fill="blue",
                       width=3)  # Knoten 8 zu 4
